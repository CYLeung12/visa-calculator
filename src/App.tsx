...
function App() {
    ...
    const createRecrod = (exitDate: Date | undefined, entryDate: Date | undefined) => {
    ...
    const countDateDiff = (exitDate: Date | undefined, entryDate: Date | undefined): number => {
        ...
        return Math.floor((entryDateInTime - exitDateInTime) / (24 * 3600 * 1000)) - 1;
    }

    return (
        <div className="md:container md:mx-auto px-7">
